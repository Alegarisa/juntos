...
The combination of these two functions is creating a new variable (that I am naming the same as it was, `id`) to follow the condition that if the variable `response_id` has the "R_6EELe7Uuwi9W7zX" value, the `id` value should be "254".  
...
elt_w1_clean_5 <- elt_w1_clean_4 %>%
  ...
  mutate(age = as.numeric(age)) %>% # making it numeric for QUAN analyses
...
Educators in this first wave of data (*n* = 43) had a mean age of 42.89 years, with an age range between 24 and 62 years (see figure 5). The majority of educators were identified as female (74%).  
...
ggplot(viz_1, aes(age)) +
  geom_histogram(fill = "#340E69", color = "white", alpha = 0.7, bins = 15) +
