...
view_df(elt_w1_clean_5) # 43 observations, 168 variables
```
...
```{r}
# final cleaned dataset wave 2
view_df(elt_w2_clean_5) # 41 observations, 168 variables
```
...
###### note: check that correct datsets are being used in each wave of data before proceeding. #####
...
```{r}
# final cleaned dataset wave 3
view_df(elt_w3_clean_3) # 41 observations, 168 variables
```
