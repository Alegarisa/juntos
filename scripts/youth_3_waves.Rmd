...
y_w2_raw %>%
  filter(finished == 0) # 412 completely empty; 405 duplicated: one with 47% and other with 80% complete 
...
y_w2_clean <- y_w2_raw %>% 
  ...
  filter(response_id != "R_12LVKPebRTdZRF3") %>% # deleting row bec. filled with -99 throughout
  arrange(id)
