...
p_w1_clean_3 <- p_w1_clean_3 %>% 
  ...
  rename(c("family_id" = "id")) # 125 participants, 91 moms, 32 dads, 1 stepmom, 1 grandparent. 96 total families
```
...
data.frame(table(p_w2_clean$id)) # duplicated ids match two-parent families, id 415 is a family of 3. Maybe get confirmation about 109 and 601, they are 2-parent fams in w1, though. 
```
