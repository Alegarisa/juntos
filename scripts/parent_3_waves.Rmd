...
```{r}
# Checking duplicates with Eli

# id 108
p_w1_clean_6 %>%
  filter(family_id == 108)
...
ids 201, 204, 206, 207, 216, 302, 310, 408, 414, 418, 501, 503, 505, 506, 607, 608, 610, 613, 614, 615, : two parent fams in w1 and w2.
