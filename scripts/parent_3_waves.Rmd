...
p_w2_clean <- p_w2_raw %>% 
  ...
  filter(response_id != "R_2sdrLRMKZvR9fwO", # deleting duped row "false start" (id 112) - this family dropped amid w2
         ...
         response_id != "R_vNctgxUZcfcMwFj") %>% # deleting row bec. it belongs to w3 (id 601)
...
data.frame(table(p_w2_clean$id)) # duplicated ids match two-parent families, id 415 is a family of 3. Need confirmation of 109 and 601. 
```

# notes on w2

id 112 after q145 empty. 
...
- Given circumstances, do we want this data? --> Ask Heather 
...
need to confirm with Eli if 109 and 601 are two-parent families. ids 201, 204, 206, 207, 216, 302, 310, 408, 414, 418, 501, 503, 505, 506, 607, 608, 610, 613, 614, 615: logs confirms that these are two-parents fams. Also these are two parent fams in w1 and w2.
