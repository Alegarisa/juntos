...
parent_scales <- parent_w1_demo_3 %>%
  ...
  select(school_id, condition, wave, family_id, participant_id, parent_role, parent_role_text, gender, parent_age, country_born, parent_ed, parent_eng_comf, youth_age, youth_country_born, adults_at_home, minors_at_home, q12_1, q12_2, q12_3, q12_4, q14, q15, q17, q20, 326:343) 
```
...
youth_scales <- youth_w1_3 %>%
  ...
  select(-7:-32) # removing individual items
```
