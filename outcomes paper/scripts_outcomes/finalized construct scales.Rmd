...
```{r}
ggplot(youth_scales, aes(grade_lev)) +
geom_bar(alpha = 0.7)
```
...
view_df(full_par_you_w1)
```
```{r}
ggplot(full_par_you_w1, aes(parent_ed)) +
geom_bar(alpha = 0.7)

ggplot(full_par_you_w1, aes(grade_lev)) +
geom_bar(alpha = 0.7)

ggplot(full_par_you_w1, aes(youth_gender)) +
geom_bar(alpha = 0.7)
```


```{r}
# full_par_you_w1 <- full_par_you_w1 %>%
...
#          y_latino = factor(y_latino),
#          y_indigenous_americas = factor(y_indigenous_americas),
#          y_race_ethnicity_no_response = factor(y_race_ethnicity_no_response),
